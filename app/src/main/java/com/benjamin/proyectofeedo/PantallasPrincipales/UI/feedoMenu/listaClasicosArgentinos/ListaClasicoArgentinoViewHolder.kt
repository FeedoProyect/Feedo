...
class ListaClasicoArgentinoViewHolder(
    ...
    fun render(
        ...
        // 💖 Pintar estado inicial del favorito
        setFavoriteIcon(comidasModel.recetas.esFavorito)

        // ❤️ Click en el corazón
        binding.cardFavBackground.setOnClickListener {
            ...
            // Actualiza el ícono + animación
            setFavoriteIcon(nuevoEstado)
            animateHeartSmooth(nuevoEstado)

            // Devuelve el cambio al fragment (para sincronizar con Supabase)
    ...
    /** ✨ Animación fluida y rebote con los drawables animados */
